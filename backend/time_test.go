...
func TestGetAllReservationTimes(t *testing.T) {
	...
	tests := []struct {
		...
		{"2300", "0000", []int64{86400, 82800, 83700, 84600, 85500}},
		{"0000", "0115", []int64{86400, 87300, 88200, 89100, 90000, 90900}},
		{"0700", "0900", []int64{25200, 26100, 27000, 27900, 28800, 29700, 30600, 31500, 32400}},
	}
...
func TestReturnTimeslotsInbetween(t *testing.T) {
	...
	tests := []struct {
		...
		{"2300", "0100", "", "0115", []string{"23:00", "23:15", "23:30", "23:45", "00:00", "00:15", "00:30", "00:45", "01:00"}},
		{"1800", "0200", "", "0000", []string{"18:00", "18:15", "18:30", "18:45", "19:00", "19:15", "19:30", "19:45", "20:00", "20:15", "20:30", "20:45", "21:00", "21:15", "21:30", "21:45", "22:00", "22:15", "22:30", "22:45", "23:00", "23:15", "23:30", "23:45", "00:00"}},
		{"1800", "0200", "1900", "0000", []string{"19:00", "19:15", "19:30", "19:45", "20:00", "20:15", "20:30", "20:45", "21:00", "21:15", "21:30", "21:45", "22:00", "22:15", "22:30", "22:45", "23:00", "23:15", "23:30", "23:45", "00:00"}},
		{"1500", "0300", "1700", "2300", []string{"17:00", "17:15", "17:30", "17:45", "18:00", "18:15", "18:30", "18:45", "19:00", "19:15", "19:30", "19:45", "20:00", "20:15", "20:30", "20:45", "21:00", "21:15", "21:30", "21:45", "22:00", "22:15", "22:30", "22:45", "23:00"}},
		{"1700", "0300", "1300", "2300", []string{"17:00", "17:15", "17:30", "17:45", "18:00", "18:15", "18:30", "18:45", "19:00", "19:15", "19:30", "19:45", "20:00", "20:15", "20:30", "20:45", "21:00", "21:15", "21:30", "21:45", "22:00", "22:15", "22:30", "22:45", "23:00"}},
		{"", "", "", "", nil},
	}
